...
description: >
  ...
  database operations, PDF generation, printing, packaging, and maintenance.

  Trigger when the user mentions:
  invoices, sessions, locum GP, THL-GP, Twickenham Health, dashboard,
  invoice form, PDF generator, SQLite DB, or any project file.
---
